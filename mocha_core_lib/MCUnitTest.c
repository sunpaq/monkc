...
constructor(MCUnitTestCase, MCUnitTestResult* resultRef)
{
	...
	{
		have_method(MCUnitTestCase, bye, xxx);
		have_method(MCUnitTestCase, setUp, xxx);
		have_method(MCUnitTestCase, tearDown, xxx);
		have_method(MCUnitTestCase, runTests, xxx);
		have_method(MCUnitTestCase, runATestMethod, char* errmsg);
	}
...
constructor(MCUnitTestSuite, xxx)
{
	...
	{
		have_method(MCUnitTestSuite, bye, xxx);
		have_method(MCUnitTestSuite, addTestCase, MCUnitTestCase* tcase);
		have_method(MCUnitTestSuite, runTestCases, xxx);
	}
...
method(MCUnitTestSuite, addTestCase, MCUnitTestCase* tcase)
{
	...
	iter=tcase;
	if(this->first_case==nil)this->first_case=tcase;
...
constructor(MCUnitTestResult, xxx)
{
	...
	{
		have_method(MCUnitTestResult, bye, xxx);
		have_method(MCUnitTestResult, addSuccessInfo, char* succinfo);
		have_method(MCUnitTestResult, addFailInfo, char* failinfo);
	}
...
constructor(MCUnitTestRunner, xxx)
{
	...
	{
		have_method(MCUnitTestRunner, bye, xxx);
		have_method(MCUnitTestRunner, addTestSuite, MCUnitTestSuite* testSuite);
		have_method(MCUnitTestRunner, runTestSuites, xxx);
	}
...
method(MCUnitTestRunner, addTestSuite, MCUnitTestSuite* testSuite)
{
	...
	iter=testSuite;
	if(this->first_suite==nil)this->first_suite=testSuite;
